...
class FairytaleAsset {
  ...
  String get workbookImagesBase =>
      workbookImg.endsWith('/') ? workbookImg.substring(0, workbookImg.length - 1) : workbookImg;

  String get voiceBase =>
      voiceDir.endsWith('/') ? voiceDir.substring(0, voiceDir.length - 1) : voiceDir;
}
...
const List<FairytaleAsset> Fairytales = [
  ...
  FairytaleAsset(
    ...
    content: '1980년도에 있었던 할머니, 손자 주현이의 3대 가족이\n바나나를 통해 따스한 과거를 담은 이야기입니다.', // 아직 없음
