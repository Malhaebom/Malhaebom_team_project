import 'package:brain_up/screens/brain_training/brain_training_start_page.dart';
import 'package:brain_up/screens/brain_training/brain_training_info_page.dart';
import 'package:brain_up/theme/colors.dart';
import 'package:brain_up/widgets/brain_training_btn.dart';
                                ...
                                onPressed: () {
                                  if (btnTextList[index * 2] != "건강정보") {
                                    Navigator.push(
                                      ...
                                      MaterialPageRoute(
                                        builder:
                                            (context) => BrainTrainingStartPage(
