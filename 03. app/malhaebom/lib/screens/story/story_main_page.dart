...
class _StoryMainPageState extends State<StoryMainPage> {
  List<String> storyImg = [
    "assets/fairytale/mother_mittens/mother_mittens.png",
    "assets/fairytale/father_wedding/father_wedding.png",
    "assets/fairytale/hobbang_son/hobbang_son.png",
  ];
  ...
  List<Map<String, String>> storyContent = [
    ...
    {"title": "아들의 호빵", "content": "1970년도에 있었던 어머니와 아들의\n따스한 과거를 담은 이야기입니다."},
  ];
